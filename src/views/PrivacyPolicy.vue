<template>
  <div class="container">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Your Clock.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Your Clock, accessible from
          <a
            href="https://your-clock.netlify.app"
            rel="external nofollow noopener"
            target="_blank"
            >https://your-clock.netlify.app</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: yourclocknoreply@gmail.com</li>
    </ul>
  </div>
</template>
